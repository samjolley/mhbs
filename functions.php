...
function utility_pro_setup() {
	...
	add_theme_support(
		...
		array(
			'utility-pro-custom'    => __( 'Custom', 'utility-pro' ),
		)
	);
...
function utility_pro_footer_creds( $creds ) {
	...
	return '[footer_copyright first="2015"] &middot; <a href="http://www.motherheartbirthservices.com">Mother Heart Birth Services, LLC</a>.';
}
...
add_action( 'init', 'sj_add_editor_styles' );
/**
